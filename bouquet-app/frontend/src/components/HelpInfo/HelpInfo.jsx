...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "You can place an order by using the Bouquet Builder to create a custom arrangement. Add items to your cart and proceed to checkout. Payment is currently available via cash on delivery.",
  },
  {
  ...
  },
  {
    ...
    answer: "We currently accept cash on delivery for eligible addresses.",
  },
  {
    ...
    <section className="help-wrap">
      ...
      <div className="help-nav">
        {CHAPTER_LINKS.map((chapter) => (
          <a key={chapter.id} href={`#${chapter.id}`} className="help-nav-link">
            {chapter.label}
          </a>
        ))}
      </div>
      ...
      <div className="help-list">
        ...
        <article id="delivery" className="help-card">
          ...
          <p className="help-text">
            ...
            enter your postal code at checkout to confirm delivery availability.
          </p>
          ...
          <div className="delivery-cards">
            ...
            <div className="delivery-row green">
              ...
              <div>
                ...
                <p>
                  2-4 hour delivery available for urgent orders (additional fee
                  applies)
                </p>
              </div>
            </div>
        ...
        <article id="returns" className="help-card">
          ...
          <ul className="dot-list">
            ...
            <li>Replacement bouquet or store credit available</li>
          ...
          <ol className="number-list">
            ...
            <li>Choose between refund, replacement, or store credit</li>
          </ol>
        </article>
        ...
        <article id="care" className="help-card">
          ...
          <div className="care-steps">
            <div className="care-step">
              ...
              <div>
                ...
                <p>
                  Remove the bouquet from packaging and any protective wrapping
                </p>
              </div>
            </div>
            <div className="care-step">
          ...
          <div className="pro-tip">
            <strong>💡 Pro Tip:</strong> Adding a small amount of sugar or lemon
            juice to the water can help extend the life of your flowers.
          </div>
        </article>
        ...
        <article id="terms" className="help-card">
          ...
          <p className="help-text">
            By accessing and using Bloomery's services, you accept and agree to
          ...
          <ul className="dot-list">
            <li>All prices are in RON and subject to change without notice</li>
            <li>
              Payment is collected at delivery for cash on delivery orders
            </li>
          ...
          <p className="help-text">
            ...
            products. Our liability is limited to the amount paid for the order
            in question.
          </p>
        </article>
      </div>
